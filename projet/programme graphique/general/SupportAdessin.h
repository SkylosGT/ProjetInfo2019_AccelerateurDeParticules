...
//Des méthodes virtuelles pure qui dessine (en fonction de l'argument = surcharge) accélérateur, faisceau ciruclaire, particules, dipole, quadrupole et section droite
//Ces méthodes seront redéfinis par les sous classes de SuppoprtADessin afin de pouvoir dessiner un accélérateur dans sa totalité sur différents supports
