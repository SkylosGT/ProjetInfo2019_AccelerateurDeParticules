...
int main() {
    ...
    /*Méthode obselete, on utilise dessine et un support à dessin*/
    //_accelerateur.affiche();
    ...
    /*Deux faisceau F1 et F2*/
    FaisceauCirculaire F1(p1, 10, 2), F2(p2, 20, 5);
    ...
    //Test de l'ajout de 2 faisceaux dans l'accélérateur
    ...
    //Test de la suppression des éléments et faisceaux de l'accélérateur
    _accelerateur.supprCollectionFaisceau();
